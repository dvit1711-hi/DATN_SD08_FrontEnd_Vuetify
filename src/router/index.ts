...
import AdminBrand from '@/pages/admin/AdminBrand.vue'
  ...
  routes: [
...

    {
      ...
      children: [
        ...
        { path: 'brand', component: AdminBrand, name: 'AdminBrand' },
        { path: 'material', component: AdminMaterial, name: 'AdminMaterial' },
        { path: 'color', component: AdminColor, name: 'AdminColor' },
